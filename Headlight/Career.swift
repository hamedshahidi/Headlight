...
class CareerData {
    ...
    static let backendDeveloper = Career(name: "Back-End Developer", requiredSkills: [
        "js", "tier-2-mathematics", "basic-unix", "basic-logism", "object-oriented-programming", "data-communications", "kotlin", "java", "csharp"
        ])
    ...
    static let computerScientist = Career(name: "Computer Scientist", requiredSkills: [
        "js", "tier-2-physics", "tier-3-mathematics", "basic-unix", "basic-logism", "object-oriented-programming", "data-communications", "java", "csharp", "c++"
        ])
    ...
    static let iOSDeveloper = Career(name: "iOS Developer", requiredSkills: [
        "tier-1-mathematics", "basic-unix", "basic-logism", "angular", "ux-prototyping", "color-theory", "object-oriented-programming", "data-communications", "swift", "xcode", "ios", "pwa"
        ])
    ...
    static let gameDeveloper = Career(name: "Game Developer", requiredSkills: [
        "tier-3-physics", "tier-3-mathematics", "basic-unix", "basic-logism", "object-oriented-programming", "data-communications", "java", "unity", "csharp", "unreal", "c++"
        ])
